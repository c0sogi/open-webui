...
def test_generate_openai_batch_embeddings_flow() -> None:
    """Test the flow of generate_openai_batch_embeddings function.

    This test verifies that the function calls the correct OpenAI embedding
    function based on the size of the input text.

    Args:
        texts (List[str]): List of texts to embed.
        expected_function (str): Expected function to be called.
    """
